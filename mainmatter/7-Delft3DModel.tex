...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth,height=0.8\linewidth]{figures/ch7/Bathymetry_cs1.png}
    ...
    \begin{subfigure}[t]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth,height=0.8\linewidth]{figures/ch7/Bathymetry_cs2.png}
