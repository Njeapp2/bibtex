...
The bed shear stresses in Figure \ref{fig: bed shear confluence} show a similar behaviour to the flow velocities. Additionally, it can be seen that the bed shear stresses increase just upstream of the confluence for the two channels and decrease within or just downstream of the confluence. The increasing bed shear stress is a result of the flow alignment toward the confluence, which leads to flow accelaration and thus to a higher near-bed velocity. 
