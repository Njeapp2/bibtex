...
For the initial water level, the water level was used at the start of the first simulated day (1.213 m). As the period of interest is 25 and 26 September 2025 (the days on which field measurements were taken), the simulation was started on 24 September 2025 to allow for model spin-up.
