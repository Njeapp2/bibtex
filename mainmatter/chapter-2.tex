...
\section{Dredging activity in the area}
...
A total of 25 permits were collected for the Paraná Guazú and 51 for the Ibicuy. On both river sections, only two permits related to channel maintenance, while all others concerned sand extraction. The analysis highlights that the requested volumes for the Ibicuy are considerably larger than those for the Paraná Guazú, despite the Ibicuy being much shorter in length.

It is important to note that the end dates of contracts are unknown. While the requests specify monthly dredging quantities, they do not indicate the duration of the works. As a result, a detailed quantitative assessment cannot be made. For the present analysis, all requests are treated as single jobs with a fixed monthly volume, allowing for a qualitative comparison between the two river sections, as shown in Figure \ref{fig:yearly dredging volumes}. The figure shows that dredging on the Paraná Guazú has been very limited over the period 2015-2023. 
