...
The river bank is divided in three parts: the toe, the bank and the overbank zone. The toe of the bank is the most susceptible to erosion when in contact with high water levels. When the water level or current is strongest, the bank zone can also be affected by the tidal currents or wave impacts\autocite{austr}.
