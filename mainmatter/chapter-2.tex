...
\section{Effect of tides and waves on the river bank}
...
There are several ways how the water could have a negative effect on the river bank. In theory the river bank failure may be caused by house placement, water saturation, weight on the river bank, vegetation, and/or tectonic activity, but most of them due to the rise of the water level. The reason behind this is that the river bank is naturally eroded when the water exerts a force on it.
The river bank is divided in three parts: the toe, the bank and the overbank zone. The toe of the bank is the most susceptible to erosion when in contact with high water levels, which can be seen in the Figure 2.5 below \autocite{australiaRiverbankCollapse}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Erosion-pins-were-used-to-quantify-bank-erosion-rates-along-the-Ningar-River-Pins-were.png}
    \caption{Effect of Water on Bank after One Year}
    \label{fig:placeholder}
\end{figure}

When the water level or current is strongest, the bank zone can also be affected by the tidal currents or wave.
