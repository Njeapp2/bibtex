...
When the water level or current is strongest, the bank zone is affected by the tidal currents or waves. This is because, as seen in the Figure 5.2, water erodes the layer of the bank where the extra water level pushes, creating a dent inside the soil layer.
...
Relevant to this project, the two situations that contribute to this problem are the elevation of the water level due to the astronomical tide, and the elevation of the water levelThe tidal currents
