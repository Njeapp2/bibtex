...
Dry:
heavy truck traffic, from interviews, observations and deaths
Natural habitats: it seems that the natural cover (grasslands and forests) has recovered quite quickly in this case. It must however be noted that changes to the original natural environment can still be severe: the original soil profile has drastically changed, meaning that even though a new natural cover has emerged, original species might not be able to survive anymore. Examples from USA
Economic: 440.000 Euros in 2023, enough for repaving around 1 kilometer of road that is in `fair' condition, by U.S. standards \autocite{crumbCostRoadMaintenance2024}. 
New rate: according to the president of Entre Ríos’ tax authority, still falls short of covering the province’s road repair costs \autocite{bellatoEntreRiosFrigerio2025}.
Air quality: silica dust can contribute to cancer for workers, exposure to nearby people unclear: study shows exposure is low, but in US ban in place, more research needed in Ibicuy
