...
Section 1.1 presents the context of the project, outlining the reasons behind its initiation. Section 1.2 then provides a detailed description of the problem at hand. Finally, Section 1.3 discusses an outline of its primary objectives, specifying what the project seeks to accomplish.
...
\begin{itemize} 
    ...
    \item What are the effects of dry sand mining in the Lower Paraná delta?
