...
This argument can once again be solidified by the drastic increase of erosion in between those time periods. After this flood event, the rate of erosion decreased again. Values and quantifications can be found in Chapter \ref{chap:results}.
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}[b]{0.45\textwidth} % Adjusted width to fit both images side by side
        \includegraphics[width=\linewidth, height=5cm]{figures/appendix-g/200.png}
        \caption{Surface Data for 2022}
        \label{fig:surface2022}
    \end{subfigure}
