...
\hline
\end{tabular}
\caption{Tidal constituents used to reconstruct the tide \autocite{BRON}.}
...
\hline
Constituent & amp\_sf & amp\_bl & $\alpha$ & lag\_hours & phi\_sf [degrees] & phi\_bl [degrees] \\
\hline
M2 & 0.252556 & 0.058178 & 0.230357 & 4.449647 & -0.464874 & 1.786061 \\
S2 & 0.041460 & 0.009899 & 0.238748 & 5.054501 & -2.525642 & 0.120888 \\
N2 & 0.094422 & 0.022490 & 0.238183 & 4.315835 & -0.546323 & 1.595923 \\
K1 & 0.118679 & 0.037176 & 0.313247 & 5.181066 & -2.543143 & -1.183031 \\
O1 & 0.186930 & 0.061275 & 0.327797 & 5.517155 & 2.694069 & -2.246504 \\
M4 & 0.029745 & 0.005636 & 0.189488 & -1.494826 & -2.608483 & 2.162333 \\
\hline
\end{tabular}
\end{table}
...
The relationship between fluvial discharge and water level at Brazo Largo was determined under the assumption of a power-law relationship ($Q = a \cdot h^b$). However, this yielded a weak relation with an $R^2$-value of 0.261. Instead, a linear fit was made and a slightly better result was found, indicating a positive increasing trend. The result and its $R^2$-value of 0.444 are shown in Figure \ref{fig:water level discharge}.

In comparison to the El Colorado and Túnel Subfluvial stations, this result is surprising. When plotting the same relationship, a clear power law dependence appears. 

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{waterlevel_discharge.png}
    \caption{Water level Discharge relationship}
    \label{fig:water level discharge}
\end{figure}
