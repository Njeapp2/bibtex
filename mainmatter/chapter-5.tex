...
\]
The damping coefficient ($\alpha$) and the tidal delay with respect to San Fernando have been determined by Brok (2022). For Brazo Largo, a damping coefficient of 0.3 and tidal delay of 4 hours were found. These values will be used as reference values when isolating the tide at Brazo Largo. The tidal signal is isolated using hourly water level data for a period of over 2 years from both Brazo Largo and San Fernando. Table 5.2 shows the tidal constituents that are considered and their period.
...
The relationship between fluvial discharge and water level was determined under the assumption of a power-law relationship ($Q = a*h^b$). However, this yielded a weak relation with an $R^2$-value of 0.261. Instead, a linear fit was made and a slightly better result was found, indicating a positive increasing trend. The result and its $R^2$-value of 0.444 are shown in Figure \ref{fig:water level discharge}.
