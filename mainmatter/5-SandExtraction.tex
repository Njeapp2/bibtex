...
In the short term, sand mining can contribute to the economic development of the area. Jobs are created and the government can profit through direct and indirect taxation of the activities. However, since all sand mining activities face a natural end (the YPF mine operator indicated that his mine had resources to stay open for 8 more years), jobs and generated government revenue are not long-term. However, a closer look at the situation in Ibicuy shows that this picture might not hold in the lunger run.
