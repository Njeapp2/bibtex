...
Examples of this can be found in the United States of America: over the past decades, the Dunes Sagebrush Lizard has seen more than 95\% of its original habitat in Texas and New Mexico disappear. This is due to the oil industry and the large scale sand mining operations that support it. In 2024, the species was listed as endangered by the U.S. Fish and Wildlife Service. https://biologicaldiversity.org/w/news/press-releases/legal-intervention-launched-to-protect-dunes-sagebrush-lizard-2025-03-12/ Sand mining leads to semi-permanent removal of habitats, which means that letting natural cover grow back may not be enough for species like these to return.

\subsubsection{Economic and social effects}
In the short term, sand mining can contribute to the economic development of the area. Jobs are created and the government can profit through direct and indirect taxation of the activities.





Weinig banen, niet op lange termijn want onzeker hoelang open. Overheid ziet er weinig van.

Bij een prijs van tweehonderd dollar per ton wordt geschat dat elke vrachtwagen uit Ibicuy ongeveer zesduizend dollar aan steunmiddelen vervoert. De provincie houdt echter slechts vier dollar per vrachtwagen over.
Om de waarde van zijn product te verlagen, vertrouwde Entre Ríos op de overvloed aan zand, de betaling van een minimale vergoeding voor de winning en de diversificatie van het transport van zijn productie. Vandaag wordt de vergoeding die de schatkist van Entre Ríos ontvangt geregeld door Resolutie 017 S. M., die 5,161 dollar vaststelt voor elke kubieke meter silicazand en 19,11 dollar voor elke kubieke meter zand bestemd voor het fracken van olie(21) SED DE ARENA

Ten  tweede  genereert  de  industrie  op  zichzelf  geen  welvaart,  aangezien  de  banen  die  voor  de  lokale  beroepsbevolking  worden  opengesteld,  alleen  bestaan  uit  schoonmaakwerk,  catering  en  bewegwijzering.

Geluid, licht
Meest genoemd: wegen
Stakeholders: weg + eigen observaties

De overmatige belading van vrachtwagens ruïneert niet alleen de wegeninfrastructuur (bruggen, bestrating of bewegwijzering), maar leidt ook tot een reeks negatieve aspecten voor de gemeente, zoals verkeersongevallen (alleen al in 2020 stierven tien mensen in dit gedeelte), grotere vertragingen voor bewoners om te verhuizen, de aanwezigheid van een grote hoeveelheid zand op de weg en minder prikkels voor de komst van toerisme WEBSITE. 

Dit scenario lokte meerdere protesten uit van buren en blokkades van National Route 12 om te eisen dat de autoriteiten de bijbehorende werken en een strategisch plan uitvoeren om de activiteit aan te passen aan het leven van de bewoners. Alleen al om de economische impact te meten die overmatig vrachtverkeer heeft op de wegeninfrastructuur, kunnen we de uiteindelijke kosten nemen van de patchwerkzaamheden die in 2021 zijn uitgevoerd en die 290 miljoen dollar hebben gekost (het equivalent van tien jaar gemeentelijke belasting voor zandwinning) en die tot op heden al weer kapot zijn WEBSITE.
...
pose health risks to nearby residents. Mining operations in Wisconsin and Minnesota are also
sources of noise pollution, water contamination, and loss of property value. In January 2021, a
...
Stofwolken zijn een dagelijkse realiteit: silicadeeltjes kleiner dan 2,5 micron verspreiden zich niet alleen over de flora, fauna, wegen en paden. Wanneer ze worden ingeademd, kunnen ze tot diep in de longen doordringen en silicose veroorzaken (Walters et al, 2015), een onomkeerbare en sluipende ziekte. Deze aandoening, die behoort tot de groep van pneumoconiose (SRT, 2018), kan jarenlang onopgemerkt blijven. In 2012 rapporteerde het Internationaal Agentschap voor Kankeronderzoek (IARC) van de Wereldgezondheidsorganisatie (WHO) een verband tussen longkanker en het inademen van kristallijn silica op de werkplek (IARC, 2012). SED DE ARENA

De sociaal-ecologische gevolgen van deze moderne "goudkoorts" in de Verenigde Staten zijn al minstens tien jaar gedocumenteerd. In 2013, na een bezoek aan elf frackinglocaties in Arkansas, Colorado, North Dakota, Pennsylvania en Texas, constateerde Amerikaanse een team van National Institute for Occupational Safety and Health het (NIOSH) hoge silicaconcentraties in de lucht. 79 % van de verzamelde monsters overschreed de aanbevolen limiet, en in sommige gevallen was het gehalte zo hoog dat de    de door de werknemers gebruikte ademhalingsmaskers niet voldoende waren15  SED DE ARENA
Gevolgen voor omwonenden lijken kleiner -> https://www.sciencedirect.com/science/article/pii/S0048969717320041#s0040
...
https://www.wpr.org/economy/business/frac-sand-mining-banned-winona-county#:~:text=Commissioner%20Marie%20Kovecsi%20said%20the%20ban%20will,pollution%2C%20increased%20truck%20traffic%20and%20economic%20instability
Supreme court
