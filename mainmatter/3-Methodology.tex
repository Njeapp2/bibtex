...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{p{3.5cm}p{8cm}p{3.5cm}}
        ...
        MarineTraffic & Live AIS vessel data & \autocite{aisMarineTraffic2025} \\
        ...
        AquaMonitor & Deltares tool that represents water gains and losses based on historical satellite imagery & \autocite{deltaresQUICKINUserManual2025} \\
        ...
        Google Earth & Satellite imagery of the globe. Can be used for a chosen time period of 1984-now & \autocite{googleGoogleEarth2025}  \\
        \bottomrule
    \end{tabularx}
