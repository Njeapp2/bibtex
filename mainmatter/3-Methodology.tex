...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{p{3.5cm}p{8cm}p{3.5cm}}
        ...
        \\
        Prefectura Naval Argentina  & Water level measurements & \citeauthor{PrefecturaNavalArgentina2018} \\
        SNIH & Water level, discharge, fine and course sediment concentration & \citeauthor{SistemaNacionalInformacion2017} \\
