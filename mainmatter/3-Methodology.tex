...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{p{3.5cm}p{8cm}p{3.5cm}}
        ...
        AquaMonitor & Deltares tool that represents water gains and losses based on historical satellite imagery & \cite{deltares} \\
