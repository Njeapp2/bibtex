...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{p{3.5cm}p{8cm}p{3.5cm}}
        ...
        MarineTraffic & Live AIS vessel data & \cite{MarineTrafficGlobalShip} 
        \\
        Prefectura Naval Argentina  & Water level measurements & \cite{PrefecturaNavalArgentina2018} \\
        SNIH & Water level, discharge, fine and course sediment concentration & \cite{SistemaNacionalInformacion2017} \\
        ...
        Google Earth & Satellite imagery of the globe. Can be used for a chosen time period of 1984-now & \cite{GoogleEarth}  \\
        \bottomrule
    \end{tabularx}
...
\begin{figure}[H]
    ...
    \caption{Measurement stations of interest on Paraná de las Palmas and Paraná Guazú \autocite{GoogleEarth}}
...
\begin{figure}[H]
    ...
    \caption{Measurement location confluence Talabera-Paraná Guazú \autocite{GoogleEarth}}
...
\begin{figure}[H]
    ...
    \caption{Measurement locations Puerto Ibicuy-Puerto Guazú \autocite{GoogleEarth}}
...
\begin{figure}[H]
    ...
    \caption{Measurement tracks of longitudinal profiles \autocite{GoogleEarth}}
