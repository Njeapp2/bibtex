...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/ch9/Sandgraphquantities.png}
    \caption{Quantities of sand mined in Argentine provinces, adapted from \cite{arenaspara}}
...
\begin{figure}
    ...
    \caption{Roundness table \autocite{.......}
    \label{fig:placeholder}
\end{figure}
