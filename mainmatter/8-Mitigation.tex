...
From the forces derived from the earth and hydrostatic pressure a force balance can be set up to calculate the resultant force R which was introduced by using the method of Blum. Equation \ref{eq:balance_forces} shows the force balance should be equal to 0 which will give the resultant force R. In Figure \ref{fig:forces_balance} an overview of the acting forces and their magnitude is shown.
