...
For the design of the sheet pile wall, the loads acting on the pile wall will be of high importance. In this case, the soil and hydraulic pressure should be defined and to be able to calculate what the acting forces on the structure will be. The soil parameters will be defined and the soil profile is taken from Section XX. For the hydraulic pressure, while the water levels are taken from Section XX. These will be further analyzed and used for the design of the sheet pile.
