...
The balance of moments around the lowest part of the sheet pile should be zero which can be seen in Equation XX. In Figure \ref{fig:moments_point} the balance of moments is shown and the point O is indicated. 

From the forces derived from the earth and hydrostatic pressure a force balance can be set up to calculate the resultant force R which was introduced by using the method of Blum. Equation \ref{eq:balance_forces} shows the force balance should be equal to 0 which will give the resultant force R. Following this equation the resultant force R is -24.31 $kN/m$. In Figure \ref{fig:forces_balance} an overview of the acting forces and their magnitude is shown.
