...
For calculating the embedded depth of a sheet pile wall multiple design methods and models are established worldwide. The most common methods are displayed in Table XX. These models are not applicable for every situation, and the model which are applicable for a  
