...
In Figure \ref{fig:earth_pressure} an overview of the active and passive earth pressure acting on the sheet pile is shown. However, when calculating the earth pressures it should be noted that on the interfaces of the soil layers the right coefficient is taken and multiplied with the effective stress $\sigma_{z}$. With the active and passive pressures acting on the sheet pile we can determine the horizontal forces. This horizontal force is calculated with Equation \ref{eq:earth_force} where the active or passive earth pressure is multiplied by the height of the layer. 
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.70\linewidth]{figures/ch8/earth_pressure.png}
%     \caption{Earth pressure}
%     \label{fig:earth_pressure}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.70\linewidth]{figures/ch8/forces_earth.png}
%     \caption{Earth forces}
%     \label{fig:earth_forces}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \begin{subfigure}[b]{0.45\textwidth}
%         \includegraphics[width=\linewidth, height=10cm]{figures/ch8/earth_pressure_small.png}
%         \caption{Earth pressure}
%         \label{fig:earth_pressure}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{0.45\textwidth}
%         \includegraphics[width=\linewidth, height=10cm]{figures/ch8/earth_force_small.png}
%         \caption{Earth forces}
%         \label{fig:earth_forces}
%     \end{subfigure}
%     \caption{Earth pressure and forces}
%     \label{fig:earth_force_pressure}
% \end{figure}
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}l r l r r@{}}
    ...
    \textbf{F [kN/m]} & \textbf{$z_c$ [m]} \\
    \midrule
    Active (right) & 1 & tri  &  3.53 & 0.67 \\
    Active (right) & 2 & rect &  7.07 & 1.50 \\
    Active (right) & 2 & tri  &  0.64 & 1.67 \\
    Active (right) & 3 & rect & 23.65 & 4.50 \\
    Active (right) & 3 & tri  & 38.29 & 5.33 \\
    Active (right) & 4 & rect & 97.00 & 8.50 \\
    Active (right) & 4 & tri  & 10.14 & 9.00 \\
    Passive (left) & 1 & tri  & 124.06 & 6.00 \\
    Passive (left) & 2 & rect & 153.84 & 8.50 \\
    Passive (left) & 2 & tri  &  35.07 & 9.00 \\
    \bottomrule
  \end{tabular}
\end{table}
...
When there is an excess of hydrostatic pressure, which means that the water levels on both side of the sheet pile wall are not on the same level, the excess hydrostatic pressure will occur. The excess hydrostatic pressure can be calculated with Equation \ref{eq:excess_water_pressure}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\linewidth]{figures/ch8/hydrostatic_pressure.png}
    \caption{Hydrostatic pressure (right) and excess hydrostatic pressure (left)}
