...
The balance of moments around the lowest part of the sheet pile should be zero, Equation \ref{eq:moment}. In Figure \ref{fig:moments_balance} the point where the moment should be equal to O is indicated. In addition, also the forces acting due to both the earth and hydrostatic are shown. From the forces derived from the earth and hydrostatic pressure and the distance to the lowest point of the sheet pile the moments can be computed.
...
From Table \ref{tab:forces_arms_moments_now}, it can be seen that the balance of moments is not 0. Which means it needs to be iteratively calculated increasing the embeddings depth to check at which depth the moments is zero.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\linewidth]{figures/ch8/force_balance.png}
    \caption{Forces acting and moment point 0}
...
\begin{table}[H]
  ...
  \begin{tabular}{@{}l r l r r r r@{}}
    ...
    \midrule
    Active (right) & 1 & Triangle  &  3.53  & 0.67 & 9.33 &  32.97 \\
    Active (right) & 2 & Rectangle &  7.07  & 1.50 & 8.50 &  60.06 \\
    Active (right) & 2 & Triangle  &  0.64  & 1.67 & 8.33 &   5.37 \\
    Active (right) & 3 & Rectangle & 23.65  & 4.50 & 5.50 & 130.07 \\
    Active (right) & 3 & Triangle  & 38.29  & 5.33 & 4.67 & 178.69 \\
    Active (right) & 4 & Rectangle & 97.00  & 8.50 & 1.50 & 145.50 \\
    Active (right) & 4 & Triangle  & 10.14  & 9.00 & 1.00 &  10.14 \\
    Hydro (right) & 4 & Triangle  & 397.31  & 9.00 & 1.00 &  10.14 \\
    Hydro (left) & 4 & Triangle  & 240.34  & 9.00 & 1.00 &  10.14 \\
    Passive (left) & 1 & Triangle  & 124.06 & 6.00 & 4.00 & -496.26 \\
    Passive (left) & 2 & Rectangle & 153.84 & 8.50 & 1.50 & -230.76 \\
    Passive (left) & 2 & Triangle  &  35.07 & 9.00 & 1.00 &  -35.07 \\
    \bottomrule
  \end{tabular}
\end{table}
...
The restoration approach by involving floodplains could be used between the area of primary school and the Cristamine mine, with the road as its boundary, as a floodplain restoration zone. This solution would be particularly valuable after mining operations have ended, allowing the area to naturally recover, increase biodiversity, and provide flood protection and water storage capacity.
