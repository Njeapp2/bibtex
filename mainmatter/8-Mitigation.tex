...
Sheet pile walls are frequently used in practices for applications such as excavations, waterfront structures, highway structures, flood protection schemes, and bridge abutments. Steel sheet pile walls are used mainly because of the high variety of combinations and the various profiles achieve high moments of resistance while still maintaining the structural requirements of the design. In addition, engineering advantages are in line with their suitability for water use, favorable ratio of steel cross section, moment of resistance, and fast progress on site, which include their functionality, and economical benefits make their use favorable (Handbook).
...
\subsection{}
As mentioned in section \ref{sect:dryminingeffects}, iron concentrations in the ground water have increased by 2200\% since sand mining operations have started and manganese concentrations are above the 
...
•	Phragmites australis (reed): known for high tolerance to heavy metals and ability to stabilize sediments \autocite{popaHEAVYMETALSACCUMULATION2023}.
