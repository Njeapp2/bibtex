...
\begin{table}[H]
  ...
  \begin{tabular}{@{}L{2.0cm} L{3.2cm} L{5.2cm} L{1.6cm}@{}}
    \toprule
    Date & Occupation & \textbf{Location} & \textbf{Language} \\
    \midrule
