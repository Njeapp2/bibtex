...
\subsection{Interests and Goals}
From the interviews that were carried out, the stakeholder's interests and goals were derived. In appendix xx, the fully typed out interviews can be found.
...
\subsubsection{Local livelihood vs. Local development}
...
\subsubsection{Property rights vs. Public river use}
