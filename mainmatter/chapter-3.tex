...
\toprule
\textbf{Stakeholder} & \textbf{Interest} & \textbf{Goals} \\
\midrule
...
\bottomrule
\end{tabularx}
\caption{Stakeholders with interests and goals}
...
The power vs. interest matrix is divided into four parts. These parts can be seen in Figure \ref{fig:power-interest} and represent the amount of power and interest with low and high. High power and high interest are stated as the players, and these will be of most importance to the project. Next, the quadrant with low power and high interest is stated as subjects, and the ones with high power but low interest are seen as the context setters. The context setters are not close to the project; however, when they want, they can be of high importance. The quadrant of low power and low interest is seen as the crowd, and they are not interested in the project. 
