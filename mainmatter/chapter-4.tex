...
\textbf{Instituto Nacional del Agua (INA)}

The first source used for our data collection is the available data from the Institute of Water (INA). Since collaboration between TU Delft and INA is the key motive for this study, our group of students and INA work with a 'our data is your data' policy. This is how the first income of data files were given to us, the work made by employees from the institute themselves.

A few examples would be papers written by C.R. Hackney, Mariano Re, Leandro Kazimierski amongst other authors that serve as comparative background studies. Furthermore, INA gave us data files containing the bathymetry in the region of interest, as well as discharge documentation, a QGIS file and water level data base in an excel sheet.
...
Consequently, this made it possible for us to get access to another bathymetry profile over the whole Paraná as well as the waterlevel data from the governmental website measured in the years 2021-2023.
...
Lastly, some sources of data came from our own contacts, after scheduling meetings with stakeholders. An example would be a case study NBS of the Paraguay river which we got as a tip from the Dutch Embassy, or the soil profiles of the dry sand mining from YPF in the Parana Region.


Sistema Nacional de Informacíon Hídrica
Water level, Discharge, Fine sediment concentration, Course sediment concentration

INA Dataviewer
Water level, Discharge, in the form of time series of historical data + simulations

Prefectura Naval
Live water level data

Aqua Monitor (Deltares tool)
Satellite observations of sedimentation/erosion
...
The whole collection of the annotated samples can be seen in the Appendix. \ref{appendix:Lab data}.
...
The echosounder is attached to a pole on the side of the boat, and dipped into the water while the boat is moving. This pole is connected to the Garmin screen giving the depth and bathymetry of the channel, as seen in the Figure 4.7 below.
...
The profile was taken on the whole trajectory between Puerto Guazu to Ibicuy in the morning upstream, and downstream on the end of the afternoon. This profile is seen in Figure 4.7 \ref{measurement locations day 2}.
...
\end{figure}
\label{measurement locations day 2}
