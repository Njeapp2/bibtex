...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        Rivers & 0.25 -- 1.00 & 1.0 -- 2.0 \\
        \bottomrule
    \end{tabular}
\end{table}

Next, one can calculate the force of the wave, assuming that the wave signal given by the boat is uniform, and a few repetitions. 
This leaves us with the theory of waves \autocite{week2.2} which states that 
