...
\begin{itemize}
    ...
    \item There is compensated for depositions of wash load in the floodplain between the stations by substracting 10 million tonnes per year from concentration peaks. This holds for all concentrations above a certain threshold value, which in this case was found to be optimal at 350 mg/l.
\end{itemize}
