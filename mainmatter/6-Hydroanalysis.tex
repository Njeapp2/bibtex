...
For the situation of the Parana Guazu, one may use the shear equation from the Open Channel Hydraulic Book cited above, since the current is moving along the side of the 
