...
In comparison to the study of \textcite{reMetodologiaParaGeneracion2009}, the amount of yearly sediment transport is significantly lower; this estimation yields approximately 1.78 millions tons per year, as opposed to 3.85 million tons per year. This  
The relatively low discharge values are representative for the time frame of this study, and therefore the time series serve as a comparison to the fieldwork. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/ch6/engelund hansen time series.png}
