...
Due to the negative change in sediment storage, the deficit must be supplied by sediment already stored in the control volume, which causes bed/bank erosion. As the amount of sand extracted is $5333.33$ tonnes/month compared to the much larger $\Delta S$ of -$19,172.88$ tonnes/month, it can be concluded that the net erosion is not primarily caused by the sand extraction. Even without extraction of sand there would still not be enough available sediment in the system.

The large sediment deficit can be explained by the hydrodynamical effects of the confluence.
