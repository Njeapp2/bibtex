...
The water elevations in Figure \ref{fig:water elevations fieldwork} are expressed with respect to the IGN datum. Therefore, the values recorded in the upstream station Puerto Ibicuy are higher than those in Brazo Largo at the same instants. In addition, the figure shows that water levels drop during the two days that measurements were carried out. When relating this to the discharges as shown in Table \ref{tab:discharges fieldwork}, it stands out that the discharge increases for a decreasing water level. Assuming that discharges are similar in the Paraná Guazú between Section 2 and Section 5, it can be seen that the discharge has increased on day 2 with respect to day 1. This is not in agreement with the positive correlation of stage and discharge as discussed in Section \ref{sec:correlation of variables}. The reason for this difference, is that the stage-discharge relationship acts on longer timescales and assumes steady flow. In contrast, the inverse relation between stage and discharge is observed on a small timescale and is due to water level variations in the Rio de la Plata. This causes a transient response in the system, acting on a much shorter timescale.
