...
Since the natural current is the relevant one in this case due to its magnitude of 1.5 [m/s] compared to 0.5 [m/s] \ref{tab:standard_values} will serve as a reference for further calculations \autocite{hasanShipinducedWaveForces2025}.
...
For the situation of the Parana Guazu, one may use the shear equation from the Open Channel Hydraulic Book cited above, since the current is moving along the side of the river bank
...
The Drag coefficient value of 1.2 is found for a surface with an angle of 90 degrees to the field \autocite{chhabrarajendraprasadDragCoefficientOverview}.
