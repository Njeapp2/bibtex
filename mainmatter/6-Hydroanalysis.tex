...
The Acoustic Doppler Current Profiler (ADCP) measures the flow velocity and depth across a river cross section by dividing the measurements into vertical bins for every ensemble. This data can be used to create a flow velocity field for the whole cross section and to create a velocity profile for multiple locations along the cross section. These velocity profiles are used to determine the Law of the Wall fit, see formula \ref{Law of the Wall}

\begin{equation}
    {u} = \left( \frac{u_*}{\kappa} \right) ln(\frac{z}{z_0})
