...
Following the analysis it is relevant to state the quantitative results, as well as what to conclude from it. 

First, the surface was recent surface was
calculated based on the 2022 map on Google Earth as of Figure \ref{fig:All Changes of the Surface in Camping}.

Then, the illustrations follow of this area of 2022
applied onto the other years of historical data until 1985. All these images can be found in the Appendix \ref{Appendix: Satellite Data}. However, the relevant years of change, 2017-2018, as well as the last sharp satellite image in 2003 are shown below.
...
\begin{figure}[H]
    ...
    \caption{All Changes of the Surface in Camping}
    \label{fig:All Changes of the Surface in Camping}
\end{figure}

After that, the same principle is applied for the second part of the camping which was not measured during the field trip, but seemed to be relevant based on the Google Earth study.

The surface areas and perimeters of the Camping La Blanqueada have been measured with Google Maps. The leftover piece of land which was present in 2003 but has been eroded since then is also traced as a surface area in a distinct colour \ref{fig:All Surface Losses Camping}. 
