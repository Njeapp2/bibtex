...
In addition to that, the current coming from the ship, both natural and return are also relevant. Since the natural current is relevant in this case, the value of 1.5 [m/s] will serve as a reference for further calculations \autocite{ship-induced wave forces}
...
- one value for $w_s$ used per cross section
- 0.2 m/s variance in ADCP measurements
