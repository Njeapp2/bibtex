...
By substituting the sediment fluxes from Table \ref{tab: Overview sediment fluxes} and the estimated sand extraction into 

\begin{equation}
    Q_\text{t,1} + Q_\text{t,2}  -  Q_\text{t,3} - Q_\text{Dredging}  = \Delta S \
    \label{eq: Filled in formula sediment balance}
\end{equation}
