...
Figure \ref{fig:Measured suspended sediment concentrations} shows, that for all three cross sections, the suspended sediment concentration is the highest near the bed, which is typical for suspended sediment. The steeper profile for cross section 2 suggests lower turbulence or smaller shear velocity, causing sediment to settle faster compared to the flatter profiles for cross sections 1 and 3.
